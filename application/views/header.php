...
<head>
    ...
    <link rel='stylesheet' href='<?=site_url('css/default.css')."?".date("Ymd",time())?>' type='text/css' media='screen'/>
    ...
    <script type='text/javascript' src='<?=site_url('js/default.js')."?".date("Ymd",time())?>'></script>
	
    <?php
        //SET CUSTOM CSS
        if (isset($css_list)) { foreach ($css_list as $css) {
            ?><link rel='stylesheet' href='<?=site_url('css/'.$css.'.css')."?".date("Ymd",time())?>' type='text/css'/><?php } }
        
        //SET CUSTOM JS
        if (isset($js_list)) { foreach ($js_list as $js) {
            ?><script type='text/javascript' src='<?=site_url('js/'.$js.'.js')."?".date("Ymd",time())?>'></script><?php } }
    ?>
